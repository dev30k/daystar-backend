...
const TABLE_NAME_PROGRAMS= "student_programs";
...
router.post('/student/register/',async (req,res)=>{
    ...
    '(fullnames,role,adm,phone,nationality,email,start_year,campus,password) values (?,?,?,?,?,?,?,?,?)';
    await connection.query(sql,[req.body.fullnames,req.body.role,req.body.adm,req.body.phone,req.body.nationality,req.body.email,req.body.start_year,req.body.campus,req.body.password],(err,rows) =>{
        if(err){
            console.log(err);
            res.json(err);
        }else{              
